...
class RoadMainTest {
    ...
    void testturning() {
        ...
        assertEquals(7, roadMain.roads.get(0).vehicles.get(0).getYpos());
        roadMain.moveVehicles();
        roadMain.checkCorners();
        roadMain.moveVehicles();
        roadMain.checkCorners();
        roadMain.moveVehicles();
        roadMain.checkCorners();
        assertEquals(25, roadMain.roads.get(1).vehicles.get(0).getYpos());
        roadMain.moveVehicles();
        roadMain.checkCorners();
        roadMain.moveVehicles();
        roadMain.checkCorners();
        roadMain.moveVehicles();
        assertEquals(-7, roadMain.roads.get(1).vehicles.get(0).getXpos());
        roadMain.checkCorners();
        roadMain.moveVehicles();
        roadMain.checkCorners();
    }
